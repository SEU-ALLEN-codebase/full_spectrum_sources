...
Fig4c
usage:
python Fig4c_soma_viz.py --p /Users/jiangshengdian/Desktop/Daily/PhD_project/Platform/fullmorpho/py/soma_marker_in_vtk/soma_0_vs_1.marker
...
writer=vtkPNGWriter()
topath='../data/Fig4/soma_marker_in_vtk'
